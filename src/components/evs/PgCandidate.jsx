        ...
        {/* <div className="mx-2 px-10 py-2 rounded-full text-lg text-center text-blue-950 font-extrabold tracking-widest bg-slate-200/70">
            ...
            <div className="px-2 py-2 h-[31rem] bg-zinc-200/50 shadow-inner space-y-3 overflow-y-auto">
                ...
                <div className="px-2 py-2 flex-1 bg-white rounded space-y-2">
                  <h2 className="px-6 py-1 rounded text-xs md:text-lg text-center text-blue-950 font-extrabold tracking-widest bg-slate-200/70">PRESIDENT</h2>
                  <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2 place-content-start overflow-y-scroll">
                      <CandidateCard data={null} />
                      <CandidateCard data={null} />
                      <CandidateCard data={null} />
                      <CandidateCard data={null} />
                      <CandidateCard data={null} />
