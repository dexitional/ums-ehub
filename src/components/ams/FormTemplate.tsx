...
function FormTemplate({ data }: Props) {
  ...
  return (
    <div className="scale-[85%] print:scale-[78%] -mt-32 print:-mt-14" ref={printRef}>
        <button onClick={handlePrint} className="absolute -top-[8.3rem] -left-10 print:hidden px-6 py-1 m-4 rounded-b-md bg-primary-accent text-white font-bold uppercase">Print</button>
        <PrintHeader />
                        ...
                        <table className="ptable">
                            ...
                            */}
                            ...
                            <tr>
                                ...
                                <td colSpan={2}><h3 className="theading" style={{fontSize:'10px !important',borderColor:'#b76117',color:'#b76117',letterSpacing:'0.07em',padding:'5px 15px'}}>TOTAL AGGREGATE : 0</h3></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td className="shead uppercase">{row?.grades && row?.grades[0] && row?.grades[0]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[0] && row?.grades[0]?.gradeWeight?.title || 'N/A'}</td>
                            </tr>
                            <tr>
                                <td className="sbody">Exams Sitting</td>
                                <td className="shead uppercase">{row?.sitting == 1 ? 'MAY/JUN':'NOV/DEC'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[1] && row?.grades[1]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[1] && row?.grades[1]?.gradeWeight?.title || 'N/A'}</td>
                            </tr>
                            <tr>
                                <td className="sbody">Index Number</td>
                                <td className="shead uppercase">{row?.indexNumber}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[2] && row?.grades[2]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[2] && row?.grades[2]?.gradeWeight?.title || 'N/A'}</td>
                            </tr>
                            <tr>
                                ...
                                <td className="shead uppercase">{row?.grades && row?.grades[3] && row?.grades[3]?.subject?.title || 'N/A'}</td> 
                                <td className="shead uppercase">{row?.grades && row?.grades[3] && row?.grades[3]?.gradeWeight?.title || 'N/A'}</td>
                            </tr>
                            <tr>
                                <td className="shead uppercase">{row?.grades && row?.grades[6] && row?.grades[6]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[6] && row?.grades[6]?.gradeWeight?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[4] && row?.grades[4]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[4] && row?.grades[4]?.gradeWeight?.title || 'N/A'}</td>
                            </tr>
                            <tr>
                                <td className="shead uppercase">{row?.grades && row?.grades[7] && row?.grades[7]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[7] && row?.grades[7]?.gradeWeight?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[5] && row?.grades[5]?.subject?.title || 'N/A'}</td>
                                <td className="shead uppercase">{row?.grades && row?.grades[5] && row?.grades[5]?.gradeWeight?.title || 'N/A'}</td>
                            </tr>
