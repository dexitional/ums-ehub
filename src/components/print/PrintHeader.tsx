...
function PrintHeader({}: Props) {
  return (
    <div className="flex flex-col">
                ...
                <span className="m-0 p-0 text-[1.75rem] print:text-2xl text-primary-accent font-bold font-serif tracking-wider text-center leading-0">OFFICE OF ACADEMIC AFFAIRS</span>
                <div className="my-8 mx-auto print:my-4 w-full max-w-4xl flex flex-row justify-center">
                    ...
                    <div className="flex-1 space-y-6 print:space-y-4 print:text-xs">
                        <div className="flex justify-end font-semibold text-slate-900 tracking-wider">
                            <p className="print:m-0 print:leading-[17px] text-sm text-left leading-[1.2rem]">Registrar's Office<br/>Martin Luther Training School<br/>Kintampo</p>
                        </div>
                        <div className="flex justify-center">
                            <p className="pl-8 print:m-0 print:leading-[17px] font-medium text-sm text-right leading-[1.2rem]">{ moment().format("Do MMMM, YYYY")}</p>
                        </div>
                    </div>
                </div>
            </div>
