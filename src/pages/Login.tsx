...
import { default as Adinkra, default as Adinkra2 } from '../assets/img/logo/mlk/logo.png'
// @ts-ignore
            ...
            <div className="pl-10 text-white space-y-10">
                ...
                <ul className="space-y-4 text-white">
                    <li className="flex items-center space-x-2">
                        <img src={Adinkra2} alt="" className="h-6"/>
            ...
            <div className="p-6 flex-1 flex flex-col items-center">
                ...
                <div className="my-6 md:my-14 w-full space-y-8">
                    ...
                    <form onSubmit={authenticateCredential} className={`${showStudentForm || showSSOForm || showVoucherForm ? 'flex':'hidden'} mx-auto py-4 px-3 md:p-4 md:w-[90%] rounded-xl border-[3px] border-primary-dark/30 bg-primary flex-col space-y-4 text-white text-lg`}>
                        ...
                        <div>
                           <input type="text" name={`username`} value={form.username} onChange={onChange} placeholder={`${showStudentForm ? 'Username' : showVoucherForm ? 'Serial':'Username' }`} className="px-4 py-2 w-full text-border-primary/20 font-medium rounded-md border-2 border-primary/20 focus:border-primary/20 bg-primary-dark/80 focus:ring-0 focus:outline-none  placeholder:text-base md:placeholder:text-base placeholder:text-white/50 placeholder:tracking-widest placeholder:uppercase" />
                        </div>
                        <div>
                           <input type="password" name={`password`} value={form.password} onChange={onChange} placeholder={`${showVoucherForm ? 'Pin':'Password'}`} className="px-4 py-2 w-full text-border-primary/20 font-medium rounded-md border-2 border-primary/20 focus:border-primary/20 bg-primary-dark/80 focus:ring-0 focus:outline-none  placeholder:text-base md:placeholder:text-base placeholder:text-white/50 placeholder:tracking-widest placeholder:uppercase" />
                        </div>
