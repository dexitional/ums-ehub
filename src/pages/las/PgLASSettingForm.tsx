...
function PgLASSettingForm({}: Props) {
      ...
      <div className="p-2 md:p-6 border bg-slate-50/50 rounded-xl space-y-6">
         <section className="flex md:space-x-6">
           <div className="flex-1 flex flex-col space-y-1 md:space-y-3">
              <h1 className="text-lg md:text-2xl tracking-wide font-semibold text-blue-950/70">{data?.id ? 'Edit':'Create'} Setting</h1>
...
export default PgLASSettingForm