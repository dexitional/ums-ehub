...
import DricNavItem from '../../components/dric/DricNavItem'
      ...
      <section className="mx-1.5 md:mx-auto w-full md:max-w-6xl flex">
         <div className="z-20 fixed w-64 h-screen bg-gradient-to-r from-white to-zinc-200/50 bg-opacity-5 flex flex-col space-y-16">
            ...
            <div className="py-4 px-6 flex-1 flex flex-col space-y-4">
                ...
                <DricNavItem title="Dashboard" url="" Icon={FaChartBar} isActive={true} />
                <DricNavItem title="Funders" url="" Icon={FaChartBar} isActive={false} />
                <DricNavItem title="Projects" url="" Icon={FaChartBar} isActive={false} />
                <DricNavItem title="Investigators" url="" Icon={FaChartBar} isActive={false} />
                <DricNavItem title="Personnels" url="" Icon={FaChartBar} isActive={false} />
                <DricNavItem title="Reports" url="" Icon={FaChartBar} isActive={false} />
